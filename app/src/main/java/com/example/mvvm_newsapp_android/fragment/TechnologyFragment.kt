...
class TechnologyFragment : Fragment(), BaseView {
...
//        lifecycle.addObserver(viewModel)
    ...
    fun fetchData(){
        list.clear();
        viewModel.getCategoryTopHeadlines("id", pageSize = 20, category = "technology")
    }

    override fun refresh() {
        isRefresh = true
        list.clear();
        viewModel.onRefreshCategoryTopHeadlines("id", category = "technology")
    }
