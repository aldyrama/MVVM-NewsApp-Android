...
class ScienceFragment : Fragment(), BaseView {
...
//        lifecycle.addObserver(viewModel)
    ...
    fun fetchData(){
        list.clear();
        viewModel.getCategoryTopHeadlines("id", pageSize = 20, category = "science")
    }

    override fun refresh() {
        isRefresh = true
        list.clear();
        viewModel.onRefreshCategoryTopHeadlines("id", category = "science")
    }
