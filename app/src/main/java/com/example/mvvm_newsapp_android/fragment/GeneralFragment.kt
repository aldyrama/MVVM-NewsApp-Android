...
class GeneralFragment : Fragment(), BaseView {
...
//        lifecycle.addObserver(viewModel)
    ...
    fun fetchData(){
        list.clear();
        viewModel.getCategoryTopHeadlines("id", pageSize = 20, category = "general")
    }

    override fun refresh() {
        isRefresh = true
        list.clear();
        viewModel.onRefreshCategoryTopHeadlines("id", category = "general")
    }
